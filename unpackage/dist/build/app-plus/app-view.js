...
Z([[4],[[5],[[4],[[5],[[5],[1,'tap']],[[4],[[5],[[4],[[5],[[5],[1,'handleTarget']],[[4],[[5],[[7],[3,'index']]]]]]]]]]]])
...
Z([3,'info'])
Z([3,'price'])
Z([a,[[2,'+'],[[2,'+'],[1,'$'],[[6],[[7],[3,'product']],[3,'price']]],[1,'']]])
Z([3,'slogan'])
Z([a,[[2,'+'],[[2,'+'],[1,''],[[6],[[7],[3,'product']],[3,'slogan']]],[1,'已购买']]])
Z([3,'loading-text'])
Z([a,[[7],[3,'loadingText']]])
...
Z(z[7])
Z([3,'__e'])
Z([[4],[[5],[[5],[1,'row']],[[2,'?:'],[[2,'=='],[[7],[3,'index']],[[7],[3,'handleCategroyInd']]],[1,'on'],[1,'']]]])
Z([[4],[[5],[[4],[[5],[[5],[1,'tap']],[[4],[[5],[[4],[[5],[[5],[1,'handleCategroyLeft']],[[4],[[5],[[7],[3,'index']]]]]]]]]]]])
Z([3,'text'])
...
Z(z[7])
Z(z[8])
Z([[2,'!'],[[2,'=='],[[7],[3,'index']],[[7],[3,'handleCategroyInd']]]])
Z([3,'banner'])
...
Z(z[11])
Z([3,'box'])
Z([[4],[[5],[[4],[[5],[[5],[1,'tap']],[[4],[[5],[[4],[[5],[[5],[[5],[1,'handleCategroy']],[[4],[[5],[1,'$0']]]],[[4],[[5],[[4],[[5],[[5],[[4],[[5],[[5],[[5],[1,'categoryList']],[1,'']],[[7],[3,'index']]]]],[[4],[[5],[[5],[[5],[1,'list']],[1,'']],[[7],[3,'i']]]]]]]]]]]]]]]])
...
var oX=_mz(z,'image',['mode',17,'src',1],[],cT,fS,gg)
_(cW,oX)
var lY=_n('view')
_rz(z,lY,'class',19,cT,fS,gg)
var aZ=_oz(z,20,cT,fS,gg)
_(lY,aZ)
_(cW,lY)
var t1=_n('view')
_rz(z,t1,'class',21,cT,fS,gg)
var e2=_n('view')
_rz(z,e2,'class',22,cT,fS,gg)
var b3=_oz(z,23,cT,fS,gg)
_(e2,b3)
_(t1,e2)
var o4=_n('view')
_rz(z,o4,'class',24,cT,fS,gg)
var x5=_oz(z,25,cT,fS,gg)
_(o4,x5)
_(t1,o4)
_(cW,t1)
_(hU,cW)
...
xQ.wxXCkey=2
_2z(z,14,oR,e,s,gg,xQ,'product','__i0__','goods_id')
_(bO,oP)
var o6=_n('view')
...
var tEB=_mz(z,'scroll-view',['class',5,'scrollY',1],[],e,s,gg)
var eFB=_v()
_(tEB,eFB)
var bGB=function(xIB,oHB,oJB,gg){
var cLB=_mz(z,'view',['bindtap',11,'class',1,'data-event-opts',2],[],xIB,oHB,gg)
var hMB=_n('view')
_rz(z,hMB,'class',14,xIB,oHB,gg)
var oNB=_oz(z,15,xIB,oHB,gg)
_(hMB,oNB)
var cOB=_n('view')
_rz(z,cOB,'class',16,xIB,oHB,gg)
_(hMB,cOB)
_(cLB,hMB)
_(oJB,cLB)
return oJB
...
eFB.wxXCkey=2
_2z(z,9,bGB,e,s,gg,eFB,'category','index','index')
_(aDB,tEB)
var oPB=_n('view')
...
var xWB=_mz(z,'view',['class',22,'hidden',1],[],eTB,tSB,gg)
var oXB=_n('view')
_rz(z,oXB,'class',24,eTB,tSB,gg)
var fYB=_mz(z,'image',['mode',-1,'src',25],[],eTB,tSB,gg)
_(oXB,fYB)
_(xWB,oXB)
var cZB=_n('view')
_rz(z,cZB,'class',26,eTB,tSB,gg)
var h1B=_v()
_(cZB,h1B)
var o2B=function(o4B,c3B,l5B,gg){
var t7B=_mz(z,'view',['bindtap',31,'class',1,'data-event-opts',2],[],o4B,c3B,gg)
var e8B=_mz(z,'image',['mode',-1,'src',34],[],o4B,c3B,gg)
_(t7B,e8B)
var b9B=_n('view')
_rz(z,b9B,'class',35,o4B,c3B,gg)
var o0B=_oz(z,36,o4B,c3B,gg)
_(b9B,o0B)
_(t7B,b9B)
_(l5B,t7B)
return l5B
...
h1B.wxXCkey=2
_2z(z,29,o2B,eTB,tSB,gg,h1B,'item','i','i')
_(xWB,cZB)
_(bUB,xWB)
return bUB
}
lQB.wxXCkey=2
_2z(z,20,aRB,e,s,gg,lQB,'category','index','index')
_(aDB,oPB)
_(cAB,aDB)
_(r,cAB)
return r
...
var z=gz$gwx_5()
var oBC=_n('view')
var hEC=_mz(z,'page-status',['bind:__l',0,'vueId',1],[],e,s,gg)
_(oBC,hEC)
var oFC=_mz(z,'page-header',['bind:__l',2,'vueId',1],[],e,s,gg)
_(oBC,oFC)
var cGC=_n('view')
_rz(z,cGC,'class',4,e,s,gg)
var oHC=_n('view')
_rz(z,oHC,'class',5,e,s,gg)
var lIC=_mz(z,'swiper',['autoplay',6,'bindchange',1,'circular',2,'class',3,'data-event-opts',4,'duration',5,'indicatorActiveColor',6,'indicatorDots',7,'interval',8],[],e,s,gg)
var aJC=_v()
_(lIC,aJC)
var tKC=function(bMC,eLC,oNC,gg){
var oPC=_n('swiper-item')
var fQC=_mz(z,'image',['mode',19,'src',1],[],bMC,eLC,gg)
_(oPC,fQC)
_(oNC,oPC)
return oNC
}
aJC.wxXCkey=2
_2z(z,17,tKC,e,s,gg,aJC,'item','index','index')
_(oHC,lIC)
var cRC=_n('view')
...
var h7C=_mz(z,'view',['bindtap',32,'class',1,'data-event-opts',2],[],o4C,x3C,gg)
var o8C=_n('view')
_rz(z,o8C,'class',35,o4C,x3C,gg)
var c9C=_mz(z,'image',['mode',-1,'src',36],[],o4C,x3C,gg)
_(o8C,c9C)
_(h7C,o8C)
var o0C=_n('view')
_rz(z,o0C,'class',37,o4C,x3C,gg)
var lAD=_oz(z,38,o4C,x3C,gg)
_(o0C,lAD)
_(h7C,o0C)
_(f5C,h7C)
return f5C
...
b1C.wxXCkey=2
_2z(z,30,o2C,e,s,gg,b1C,'item','index','index')
_(oBC,eZC)
var fCC=_v()
_(oBC,fCC)
if(_oz(z,39,e,s,gg)){fCC.wxVkey=1
var aBD=_n('view')
_rz(z,aBD,'class',40,e,s,gg)
var tCD=_mz(z,'image',['mode',-1,'src',41],[],e,s,gg)
_(aBD,tCD)
_(fCC,aBD)
}
var cDC=_v()
...
var eDD=_n('view')
_rz(z,eDD,'class',43,e,s,gg)
var bED=_n('view')
_rz(z,bED,'class',44,e,s,gg)
var oFD=_oz(z,45,e,s,gg)
_(bED,oFD)
_(eDD,bED)
var xGD=_n('view')
_rz(z,xGD,'class',46,e,s,gg)
var oHD=_v()
_(xGD,oHD)
var fID=function(hKD,cJD,oLD,gg){
var oND=_mz(z,'view',['bindtap',51,'class',1,'data-event-opts',2],[],hKD,cJD,gg)
var lOD=_n('view')
_rz(z,lOD,'class',54,hKD,cJD,gg)
var aPD=_n('view')
_rz(z,aPD,'class',55,hKD,cJD,gg)
var tQD=_oz(z,56,hKD,cJD,gg)
_(aPD,tQD)
_(lOD,aPD)
_(oND,lOD)
var eRD=_n('view')
_rz(z,eRD,'class',57,hKD,cJD,gg)
var bSD=_n('view')
_rz(z,bSD,'class',58,hKD,cJD,gg)
var oTD=_oz(z,59,hKD,cJD,gg)
_(bSD,oTD)
_(eRD,bSD)
var xUD=_n('view')
_rz(z,xUD,'class',60,hKD,cJD,gg)
var oVD=_oz(z,61,hKD,cJD,gg)
_(xUD,oVD)
_(eRD,xUD)
_(oND,eRD)
var fWD=_n('view')
_rz(z,fWD,'class',62,hKD,cJD,gg)
var cXD=_mz(z,'image',['mode',-1,'src',63],[],hKD,cJD,gg)
_(fWD,cXD)
_(oND,fWD)
_(oLD,oND)
return oLD
...
oHD.wxXCkey=2
_2z(z,49,fID,e,s,gg,oHD,'item','index','index')
_(eDD,xGD)
_(cDC,eDD)
}
fCC.wxXCkey=1
...
var b7D=_mz(z,'input',['placeholder',6,'placeholderStyle',1,'type',2],[],e,s,gg)
_(e6D,b7D)
var o8D=_n('view')
